...
def movie_details(x):
    ...
    for i in name_data:
        if "(" not in i:
            ...
            posterlink='https://www.imbd.com'+poster
            ...
            if 'min' in time:
                minute=time.strip('min').split("h")
                rt=str(runtime+int(minute[1]))+"minutes"
                ...
                genre_1=soup.find("div",class_="subtext").a.text
                ...
                for l in lang:
                    ...
                    for j in la:
                        if "Language:" in j:
                            ...
                            dictionary={'name':name,'director':dr,"country":country,"language":languag,"posterimage":posterlink,"bio":summary,"runtime":rt,"genre":genre_1}

    f=open("imdb_task_4.json",'w')
